...
icon_path = "C:/Users/smm/Downloads/1.png"
icon = Image.open(icon_path)

# Convert the image to Base64
icon_base64 = base64.b64encode(icon.tobytes()).decode("utf-8")
...
data = pd.read_csv("C:/Users/smm/Downloads/final_HR.csv")
...
# #------------------------------------------------------------------------------------------------
def generate_charts_and_summary(data, selected_state, selected_district):
...
marginal_data_rural = data[data['District'] == selected_district][marginal_cols_rural].sum().values
marginal_data_urban = data[data['District'] == selected_district][marginal_cols_urban].sum().values
